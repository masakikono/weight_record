...
final calendarModelProvider =
    StateNotifierProvider<CalendarModelState, CalendarModel>(
        (ref) => CalendarModelState());
...
class CalendarModelState extends StateNotifier<CalendarModel> {
  CalendarModelState()
      : super(CalendarModel(
            yearAndMonth:
                DayModel().getYearAndMonthString(date: DateTime.now())));
